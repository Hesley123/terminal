...
public:
    ...
    bool SearchText(const std::wstring_view& needle, SearchFlag flags, std::vector<til::point_span>& results) const;
    bool SearchText(const std::wstring_view& needle, SearchFlag flags, til::CoordType rowBeg, til::CoordType rowEnd, std::vector<til::point_span>& results) const;
